 ...
 * 扩展入口：只做登记，不含任何逻辑。
 *
 * 这一版登记「保存修订」「登记用户确认」「完成任务」三个写入工具、「查看条目」与「查询任务状态」两个只读工具，以及执行者对用户说话一律要经的「回复」工具，合格时它结束本次运行
...
import { registerRecordConfirmation } from "./tools/record_confirmation.ts";
