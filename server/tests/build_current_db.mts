...
saveRevision({ ...call("call-r2"), userMessages }, {
  operations: [
    { op: "update", item: "UC-001", base_version: 1, fields: { 名称: "买家申请退款" } },
    { op: "update", item: "TBD-001", base_version: 1, fields: { 状态: "已解决", 关联条目: ["UC-001"] },
      sources: [{ kind: "用户的话", excerpt: "七天内", supports: [{ field: "状态" }] }] },
    { op: "add", collection: "用例", fields: { 名称: "撤销申请", 步骤: ["撤销"] }, sources: [source] },
  ],
});
saveRevision(call("call-r3"), { operations: [{ op: "delete", item: "UC-002", base_version: 1 }] });
